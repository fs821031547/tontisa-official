...
module.exports = app => {
  class DemoController extends app.ApiService {
    async index() {
      const baseDir = app.baseDir;
      console.log('baseDir:',baseDir);
      const srcPath = path.join(baseDir, 'app/public/css/style.less');
      const distPath = path.join(baseDir, 'app/public/css/style.css');
      ...
      await this.ctx.render('index',{ a: 'pm 10点半' });
    }
  }
